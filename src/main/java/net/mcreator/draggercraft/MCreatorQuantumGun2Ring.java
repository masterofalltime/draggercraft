...
public class MCreatorQuantumGun2Ring extends Elementsdraggercraft.ModElement {
	@ObjectHolder("draggercraft:quantumgun2ring")
	public static final Item block = null;
	@ObjectHolder("draggercraft:entitybulletquantumgun2ring")
	public static final EntityType arrow = null;

	public MCreatorQuantumGun2Ring(Elementsdraggercraft instance) {
		super(instance, 39);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity> create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				0.5f, 0.5f)).build("entitybulletquantumgun2ring").setRegistryName("entitybulletquantumgun2ring"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(MCreatorDraggerStuff.tab).maxDamage(550));
			setRegistryName("quantumgun2ring");
		}
		...
		public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			...
			if (slot == EquipmentSlotType.MAINHAND) {
				multimap.put(SharedMonsterAttributes.ATTACK_DAMAGE.getName(), new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "ranged_item_damage",
						(double) 1, AttributeModifier.Operation.ADDITION));
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(MCreatorQuantumBullet.block, (int) (1));
		}
