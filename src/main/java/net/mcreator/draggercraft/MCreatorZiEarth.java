...
public class MCreatorZiEarth extends Elementsdraggercraft.ModElement {
	@ObjectHolder("draggercraft:ziearth")
	public static final Block block = null;

	public MCreatorZiEarth(Elementsdraggercraft instance) {
		super(instance, 10);
	}
