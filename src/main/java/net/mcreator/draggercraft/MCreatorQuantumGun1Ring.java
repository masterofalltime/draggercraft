...
public class MCreatorQuantumGun1Ring extends Elementsdraggercraft.ModElement {
	@ObjectHolder("draggercraft:quantumgun1ring")
	public static final Item block = null;
	@ObjectHolder("draggercraft:entitybulletquantumgun1ring")
	public static final EntityType arrow = null;

	public MCreatorQuantumGun1Ring(Elementsdraggercraft instance) {
		super(instance, 34);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity> create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				0.5f, 0.5f)).build("entitybulletquantumgun1ring").setRegistryName("entitybulletquantumgun1ring"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(MCreatorDraggerStuff.tab).maxDamage(500));
			setRegistryName("quantumgun1ring");
		}
