...
public class MCreatorZiEarthBricks extends Elementsdraggercraft.ModElement {
	@ObjectHolder("draggercraft:ziearthbricks")
	public static final Block block = null;

	public MCreatorZiEarthBricks(Elementsdraggercraft instance) {
		super(instance, 13);
	}
