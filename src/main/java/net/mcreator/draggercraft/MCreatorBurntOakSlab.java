...
public class MCreatorBurntOakSlab extends Elementsdraggercraft.ModElement {
	@ObjectHolder("draggercraft:burntoakslab")
	public static final Block block = null;

	public MCreatorBurntOakSlab(Elementsdraggercraft instance) {
		super(instance, 22);
	}
