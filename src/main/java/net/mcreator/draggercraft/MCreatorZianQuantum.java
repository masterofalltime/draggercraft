...
public class MCreatorZianQuantum extends Elementsdraggercraft.ModElement {
	@ObjectHolder("draggercraft:zianquantum")
	public static final Block block = null;

	public MCreatorZianQuantum(Elementsdraggercraft instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("zianquantum");
		}

		@Override
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			return Collections.singletonList(new ItemStack(MCreatorRawQuantum.block, (int) (1)));
		}
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("zianquantum", "zianquantum", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == MCreatorZiEarth.block.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 6), Placement.COUNT_RANGE, new CountRangeConfig(20, 32, 32, 64)));
		}
	}
}
