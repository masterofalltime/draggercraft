...
public class MCreatorZi_Portal_Block extends Elementsdraggercraft.ModElement {
	@ObjectHolder("draggercraft:zi_portal_block")
	public static final Block block = null;

	public MCreatorZi_Portal_Block(Elementsdraggercraft instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("zi_portal_block");
		}
